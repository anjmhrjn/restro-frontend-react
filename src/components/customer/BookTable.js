                                ...
                                <div className="col-lg-7 ">
                                    ...
                                    <form id="BookingForm" className="text-dark">
                                        ...
                                        <div class="mb-3 d-flex justify-content-center">
                                            <button type="button" class="btn btn-primary me-3" onClick={reserveClick}>Reserve <i class="far fa-check-square ms-2"></i></button>
                                            <button type="button" class="btn btn-secondary me-3" onClick={goBack}>Go Back <i class="far fa-check-square ms-2"></i></button>
                                        </div>
                                    </form>
